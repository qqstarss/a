    ...
    <div id="proWrap">
        ...
        <div class="com-cont">
            <div :class="['ls-l', mFd ? 'lm-fx' :'']">
                <div :class="['l-men-com',mNb == 0 ?'l-men-a' :'l-men-b']" @click="setSlidDo(0)">关于我们</div>
                ...
                <div :class="['l-men-com',mNb == 1 ?'l-men-a' :'l-men-b']" @click="setSlidDo(1)"><a href="#j">联系我们</a></div>
                <div :class="['l-men-com',mNb == 2 ?'l-men-a' :'l-men-b']" @click="setSlidDo(2)"><a href="#k">诚聘英才</a></div>
